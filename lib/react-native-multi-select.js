...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    tagItemStyle: PropTypes.object,
    tagTextStyle: PropTypes.object,
    tagCloseIconStyle: PropTypes.object,
    tagContainerStyle: PropTypes.object,
    menuDownIconStyle: PropTypes.object
  };
      ...
      return (
        <View
          style={[
            styles.selectedItem,
            {
              // width: item[displayKey].length * 8 + 60,  TODO
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Icon
                      name={hideSubmitButton ? 'menu-down' : 'menu-right'}
                      style={[styles.indicator, menuDownIconStyle]}
                    />
                  </View>
                </TouchableWithoutFeedback>
              </View>
